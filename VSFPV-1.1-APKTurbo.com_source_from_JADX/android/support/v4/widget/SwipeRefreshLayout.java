...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C01703 extends BaseAnimationListener {
        C01703() {
            super();
        }
    ...
    class C01714 extends BaseAnimationListener {
        C01714() {
            super();
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mReturnToStartPositionListener = new C01703();
        this.mShrinkAnimationListener = new C01714();
