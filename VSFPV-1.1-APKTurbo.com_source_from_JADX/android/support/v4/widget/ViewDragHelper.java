...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C00601();
    ...
    private final Runnable mSetIdleRunnable = new C00612();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C00601 implements Interpolator {
        C00601() {
        }
