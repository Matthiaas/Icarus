        ...
        int getEntryDir() {
            ...
            while (this.charIndex < this.length && firstNonEmptyEmbeddingLevel == 0) {
                switch (dirTypeForward()) {
                    ...
                    case (byte) 9:
                        break;
                    case C0127R.styleable.PercentLayout_Layout_layout_paddingPercent /*14*/:
                    case (byte) 15:
                        embeddingLevel++;
                        embeddingLevelDir = -1;
                        break;
                    case (byte) 16:
                    case C0127R.styleable.PercentLayout_Layout_layout_paddingLeftPercent /*17*/:
                        embeddingLevel++;
                        embeddingLevelDir = 1;
                        break;
                    case C0127R.styleable.PercentLayout_Layout_layout_paddingRightPercent /*18*/:
                        embeddingLevel--;
                        embeddingLevelDir = 0;
                        break;
                    default:
